...
import com.macheal.app.prospect.exception.dto.ErrorResponse;
...
public class DefaultExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleException(final DisabledException ex) {
        log.error(EXCEPTION_OCCURRED_MSG, ex);
        return new ResponseEntity<>(buildErrorResponse("Account is not yet verified", Collections.emptyList()),
